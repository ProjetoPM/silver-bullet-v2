...
const selectRaw = (state) => state.activityDurationEstimates.list;
...
const activityDurationEstimatesListSelectors = {
  selectLoading,
  selectRows,
  selectCount,
  selectOrderBy,
...
export default activityDurationEstimatesListSelectors;
