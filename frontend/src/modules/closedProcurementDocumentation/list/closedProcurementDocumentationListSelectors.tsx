...
const selectRaw = (state) => state.closedProcurementDocumentation.list;
...
const closedProcurementDocumentationListSelectors = {
  selectLoading,
  selectRows,
  selectCount,
  selectOrderBy,
...
export default closedProcurementDocumentationListSelectors;
