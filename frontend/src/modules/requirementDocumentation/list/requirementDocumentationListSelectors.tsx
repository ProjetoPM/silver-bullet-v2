...
const selectRaw = (state) => state.requirementDocumentation.list;
...
const requirementDocumentationListSelectors = {
  selectLoading,
  selectRows,
  selectCount,
  selectOrderBy,
...
export default requirementDocumentationListSelectors;
