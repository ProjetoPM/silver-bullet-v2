...
const selectRaw = (state) => state.resourceBreakdownStructure.list;
...
const resourceBreakdownStructureListSelectors = {
  selectLoading,
  selectRows,
  selectCount,
  selectOrderBy,
...
export default resourceBreakdownStructureListSelectors;
