...
const selectRaw = (state) => state.requirementsManagementPlan.list;
...
const requirementsManagementPlanListSelectors = {
  selectLoading,
  selectRows,
  selectCount,
  selectOrderBy,
...
export default requirementsManagementPlanListSelectors;
