...
const selectRaw = (state) => state.procurementManagementPlan.list;
...
const procurementManagementPlanListSelectors = {
  selectLoading,
  selectRows,
  selectCount,
  selectOrderBy,
...
export default procurementManagementPlanListSelectors;
