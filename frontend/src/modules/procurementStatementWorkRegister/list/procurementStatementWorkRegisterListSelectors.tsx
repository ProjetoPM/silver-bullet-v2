...
const selectRaw = (state) => state.procurementStatementWorkRegister.list;
...
const procurementStatementWorkRegisterListSelectors = {
  selectLoading,
  selectRows,
  selectCount,
  selectOrderBy,
...
export default procurementStatementWorkRegisterListSelectors;
