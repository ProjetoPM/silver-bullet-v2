...
const selectRaw = (state) => state.teamPerformanceEvaluation.list;
...
const teamPerformanceEvaluationListSelectors = {
  selectLoading,
  selectRows,
  selectCount,
  selectOrderBy,
...
export default teamPerformanceEvaluationListSelectors;
