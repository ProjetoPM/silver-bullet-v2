...
const selectRaw = (state) => state.communicationsManagementPlan.list;
...
const communicationsManagementPlanListSelectors = {
  selectLoading,
  selectRows,
  selectCount,
  selectOrderBy,
...
export default communicationsManagementPlanListSelectors;
