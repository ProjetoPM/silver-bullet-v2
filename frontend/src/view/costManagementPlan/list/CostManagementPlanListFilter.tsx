...
const schema = yup.object().shape({
  processesManagingProjectCosts: yupFilterSchemas.string(
  ...
  rulesPerformanceMeasurement: yupFilterSchemas.string(
    i18n('entities.costManagementPlan.fields.rulesPerformanceMeasurement'),
  ),
  unitsMeasureUsed: yupFilterSchemas.string(
    i18n('entities.costManagementPlan.fields.unitsMeasureUsed'),
  ),
  levelPrecision: yupFilterSchemas.string(
...
const emptyValues = {
  processesManagingProjectCosts: null,
  levelAccuracy: null,
  organizationalProceduresLinks: null,
  rulesPerformanceMeasurement: null,
  unitsMeasureUsed: null,
  levelPrecision: null,
...
function CostManagementPlanListFilter(props) {
...
export default CostManagementPlanListFilter;