...
function ProcurementManagementPlanFormModal(props) {
  const [saveLoading, setSaveLoading] = useState(false);

  const doSubmit = async (_, data) => {
    try {
      setSaveLoading(true);
      const { id } = await ProcurementManagementPlanService.create(data);
...
export default ProcurementManagementPlanFormModal;
