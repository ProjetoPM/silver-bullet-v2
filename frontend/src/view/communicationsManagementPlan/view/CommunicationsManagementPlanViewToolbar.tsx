...
function CommunicationsManagementPlanViewToolbar(props) {
  const [
  ...
  return (
    <div className="mb-4">
      {hasPermissionToEdit && (
        <Link to={`/communications-management-plan/${id}/edit`}>
          <button
...
export default CommunicationsManagementPlanViewToolbar;
