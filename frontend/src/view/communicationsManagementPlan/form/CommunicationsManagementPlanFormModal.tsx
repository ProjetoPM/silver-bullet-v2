...
function CommunicationsManagementPlanFormModal(props) {
  const [saveLoading, setSaveLoading] = useState(false);

  const doSubmit = async (_, data) => {
    try {
      setSaveLoading(true);
      const { id } = await CommunicationsManagementPlanService.create(data);
...
export default CommunicationsManagementPlanFormModal;
