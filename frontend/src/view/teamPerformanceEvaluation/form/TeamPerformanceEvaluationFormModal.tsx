...
function TeamPerformanceEvaluationFormModal(props) {
  const [saveLoading, setSaveLoading] = useState(false);

  const doSubmit = async (_, data) => {
    try {
      setSaveLoading(true);
      const { id } = await TeamPerformanceEvaluationService.create(data);
...
export default TeamPerformanceEvaluationFormModal;
