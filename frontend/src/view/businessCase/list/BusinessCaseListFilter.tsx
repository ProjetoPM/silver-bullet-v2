...
const schema = yup.object().shape({
  ...
  situationAnalysis: yupFilterSchemas.string(
    i18n('entities.businessCase.fields.situationAnalysis'),
  ),
  recommendation: yupFilterSchemas.string(
    i18n('entities.businessCase.fields.recommendation'),
  ),
  evaluation: yupFilterSchemas.string(
...
function BusinessCaseListFilter(props) {
...
export default BusinessCaseListFilter;