...
function BusinessCaseForm(props) {
  ...
  const [initialValues] = useState(() => {
    ...
    return {
      ...
      situationAnalysis: record.situationAnalysis,
    ...
    <FormProvider {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)}>
        <div className="w-full sm:w-md md:w-md lg:w-md">
          ...
          hint={i18n('entities.businessCase.hints.businessNeeds')}
            required={false}
          autoFocus
          />
        </div>
        <div className="w-full sm:w-md md:w-md lg:w-md mt-4">
          ...
          hint={i18n('entities.businessCase.hints.situationAnalysis')}
            required={false}
          />
        </div>
        <div className="w-full sm:w-md md:w-md lg:w-md mt-4">
          ...
          hint={i18n('entities.businessCase.hints.recommendation')}
            required={false}
          />
        </div>
        <div className="w-full sm:w-md md:w-md lg:w-md mt-4">
          ...
          hint={i18n('entities.businessCase.hints.evaluation')}
            required={false}
          />
        </div>
