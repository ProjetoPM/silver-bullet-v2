...
function ClosedProcurementDocumentationFormModal(props) {
  const [saveLoading, setSaveLoading] = useState(false);

  const doSubmit = async (_, data) => {
    try {
      setSaveLoading(true);
      const { id } = await ClosedProcurementDocumentationService.create(data);
...
export default ClosedProcurementDocumentationFormModal;
