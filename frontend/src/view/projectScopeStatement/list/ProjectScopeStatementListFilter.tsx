...
const schema = yup.object().shape({
  productScopeDescription: yupFilterSchemas.string(
  ...
  deliverables: yupFilterSchemas.string(
    i18n('entities.projectScopeStatement.fields.deliverables'),
  ),
  projectExclusions: yupFilterSchemas.string(
    i18n('entities.projectScopeStatement.fields.projectExclusions'),
  ),
});

const emptyValues = {
  productScopeDescription: null,
  acceptanceCriteria: null,
  deliverables: null,
  projectExclusions: null,
}
...
function ProjectScopeStatementListFilter(props) {
...
export default ProjectScopeStatementListFilter;