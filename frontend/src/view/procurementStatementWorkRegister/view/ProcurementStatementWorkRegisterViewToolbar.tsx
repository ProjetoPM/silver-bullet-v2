...
function ProcurementStatementWorkRegisterViewToolbar(props) {
  const [
  ...
  return (
    <div className="mb-4">
      {hasPermissionToEdit && (
        <Link to={`/procurement-statement-work-register/${id}/edit`}>
          <button
...
export default ProcurementStatementWorkRegisterViewToolbar;
