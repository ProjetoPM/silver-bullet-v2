...
const schema = yup.object().shape({
  ...
  mainDeliveriesSchedule: yupFilterSchemas.string(
    i18n('entities.procurementStatementWorkRegister.fields.mainDeliveriesSchedule'),
  ),
  additionalInformation: yupFilterSchemas.string(
    i18n('entities.procurementStatementWorkRegister.fields.additionalInformation'),
  ),
  procurementManagement: yupFilterSchemas.string(
    i18n('entities.procurementStatementWorkRegister.fields.procurementManagement'),
  ),
});

const emptyValues = {
  descriptionItemPurchased: null,
  associatedContractTypes: null,
  vendorSelectionCriteria: null,
  restrictions: null,
  premises: null,
  mainDeliveriesSchedule: null,
  additionalInformation: null,
  procurementManagement: null,
}
...
function ProcurementStatementWorkRegisterListFilter(props) {
...
export default ProcurementStatementWorkRegisterListFilter;