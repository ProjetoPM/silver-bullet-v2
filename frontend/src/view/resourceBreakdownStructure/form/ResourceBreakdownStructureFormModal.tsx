...
function ResourceBreakdownStructureFormModal(props) {
  const [saveLoading, setSaveLoading] = useState(false);

  const doSubmit = async (_, data) => {
    try {
      setSaveLoading(true);
      const { id } = await ResourceBreakdownStructureService.create(data);
...
export default ResourceBreakdownStructureFormModal;
