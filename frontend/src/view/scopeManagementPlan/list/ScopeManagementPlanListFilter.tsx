...
const schema = yup.object().shape({
  projectScopeSpecificationProcess: yupFilterSchemas.string(
    i18n('entities.scopeManagementPlan.fields.projectScopeSpecificationProcess'),
  ),
  processesMaintainingWBS: yupFilterSchemas.string(
    i18n('entities.scopeManagementPlan.fields.processesMaintainingWBS'),
  ),
  deliveryAcceptanceProcess: yupFilterSchemas.string(
    i18n('entities.scopeManagementPlan.fields.deliveryAcceptanceProcess'),
  ),
  scopeChangeManagementPlan: yupFilterSchemas.string(
    i18n('entities.scopeManagementPlan.fields.scopeChangeManagementPlan'),
  ),
  processMaintained: yupFilterSchemas.string(
    i18n('entities.scopeManagementPlan.fields.processMaintained'),
  ),
});

const emptyValues = {
  projectScopeSpecificationProcess: null,
  processesMaintainingWBS: null,
  deliveryAcceptanceProcess: null,
  scopeChangeManagementPlan: null,
  processMaintained: null,
}
...
function ScopeManagementPlanListFilter(props) {
...
export default ScopeManagementPlanListFilter;