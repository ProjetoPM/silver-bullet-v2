...
function RequirementDocumentationFormModal(props) {
  const [saveLoading, setSaveLoading] = useState(false);

  const doSubmit = async (_, data) => {
    try {
      setSaveLoading(true);
      const { id } = await RequirementDocumentationService.create(data);
...
export default RequirementDocumentationFormModal;
