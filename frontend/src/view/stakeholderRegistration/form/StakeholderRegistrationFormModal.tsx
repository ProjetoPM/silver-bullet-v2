...
function StakeholderRegistrationFormModal(props) {
  const [saveLoading, setSaveLoading] = useState(false);

  const doSubmit = async (_, data) => {
    try {
      setSaveLoading(true);
      const { id } = await StakeholderRegistrationService.create(data);
...
export default StakeholderRegistrationFormModal;
