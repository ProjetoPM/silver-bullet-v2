...
const schema = yup.object().shape({
  activityLabel: yupFilterSchemas.string(
    i18n('entities.activityList.fields.activityLabel'),
  ),
  milestone: yupFilterSchemas.string(
  ...
  projectPhase: yupFilterSchemas.string(
    i18n('entities.activityList.fields.projectPhase'),
  ),
  wBSId: yupFilterSchemas.string(
    i18n('entities.activityList.fields.wBSId'),
  ),
  activityDescription: yupFilterSchemas.string(
...
function ActivityListListFilter(props) {
...
export default ActivityListListFilter;