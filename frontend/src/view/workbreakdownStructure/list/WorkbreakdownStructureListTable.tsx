...
function WorkbreakdownStructureListTable(props) {
  const [
    recordIdToDestroy,
  ...
  const hasPermissionToEdit = useSelector(
    workbreakdownStructureSelectors.selectPermissionToEdit,
  );
            ...
            <tr>
              <TableColumnHeader>
                ...
                <TableColumnHeader
                  ...
                  name={'name'}
                  label={i18n(
                    'entities.workbreakdownStructure.fields.name',
                  )}
                />
                <TableColumnHeader
                  label={i18n(
                ...
                <tr key={row.id}>
                  ...
                  >
                    <Link
                      ...
                      to={`/workbreakdown-structure/${row.id}`}
                    ...
                    {hasPermissionToEdit && (
                      <Link
                        className="inline-flex justify-center items-center w-9 h-9 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full"
                        to={`/workbreakdown-structure/${row.id}/edit`}
...
export default WorkbreakdownStructureListTable;
