...
import ResourceAutocompleteFormItem from 'src/view/resource/autocomplete/ResourceAutocompleteFormItem';

const schema = yup.object().shape({
  activity: yupFilterSchemas.relationToOne(
    i18n('entities.resourceRequirements.fields.activity'),
  ),
  resource: yupFilterSchemas.relationToOne(
    i18n('entities.resourceRequirements.fields.resource'),
  ),
  requiredAmountResource: yupFilterSchemas.string(
...
function ResourceRequirementsListFilter(props) {
...
export default ResourceRequirementsListFilter;