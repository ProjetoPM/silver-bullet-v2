...
const schema = yup.object().shape({
  ...
  resource: yupFormSchemas.relationToOne(
    i18n('entities.resourceRequirements.fields.resource'),
    {},
  ),
  requiredAmountResource: yupFormSchemas.string(
    i18n('entities.resourceRequirements.fields.requiredAmountResource'),
    {},
  ),
});

function ResourceRequirementsForm(props) {
  ...
  const [initialValues] = useState(() => {
    ...
    return {
      ...
      requiredAmountResource: record.requiredAmountResource,
    };
  });
