...
import selectors from 'src/modules/resource/resourceSelectors';

function ResourceViewItem(props) {
  ...
  const displayableRecord = (record) => {
    ...
    return <div key={record.id}>{record.resourceName}</div>;
  };
