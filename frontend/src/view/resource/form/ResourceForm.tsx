...
const schema = yup.object().shape({
  resourceName: yupFormSchemas.string(
    i18n('entities.resource.fields.resourceName'),
    {},
  ),
  resourceDescription: yupFormSchemas.string(
    i18n('entities.resource.fields.resourceDescription'),
    {},
  ),
  resourceCostperUnit: yupFormSchemas.decimal(
    i18n('entities.resource.fields.resourceCostperUnit'),
    {},
  ),
  resourceType: yupFormSchemas.string(
...
function ResourceForm(props) {
  ...
  const [initialValues] = useState(() => {
    ...
    return {
      ...
      resourceCostperUnit: record.resourceCostperUnit,
    ...
    <FormProvider {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)}>
        <div className="w-full sm:w-md md:w-md lg:w-md">
          ...
          hint={i18n('entities.resource.hints.resourceName')}
            required={false}
          autoFocus
          />
        </div>
        <div className="w-full sm:w-md md:w-md lg:w-md mt-4">
          ...
          hint={i18n('entities.resource.hints.resourceDescription')}
            required={false}
          />
        </div>
        <div className="w-full sm:w-md md:w-md lg:w-md mt-4">
          ...
          hint={i18n('entities.resource.hints.resourceCostperUnit')}  
            required={false}
          />
        </div>
        <div className="w-full sm:w-md md:w-md lg:w-md mt-4">
          ...
          hint={i18n('entities.resource.hints.resourceType')}
            required={false}
          />
        </div>
