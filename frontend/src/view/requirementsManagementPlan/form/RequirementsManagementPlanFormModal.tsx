...
function RequirementsManagementPlanFormModal(props) {
  const [saveLoading, setSaveLoading] = useState(false);

  const doSubmit = async (_, data) => {
    try {
      setSaveLoading(true);
      const { id } = await RequirementsManagementPlanService.create(data);
...
export default RequirementsManagementPlanFormModal;
