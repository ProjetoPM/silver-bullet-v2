...
const schema = yup.object().shape({
  requirementsActivities: yupFilterSchemas.string(
    i18n('entities.requirementsManagementPlan.fields.requirementsActivities'),
  ),
  configurationManagementActivities: yupFilterSchemas.string(
    i18n('entities.requirementsManagementPlan.fields.configurationManagementActivities'),
  ),
  requirementsPrioritizationProcess: yupFilterSchemas.string(
    i18n('entities.requirementsManagementPlan.fields.requirementsPrioritizationProcess'),
  ),
  metricsRationale: yupFilterSchemas.string(
    i18n('entities.requirementsManagementPlan.fields.metricsRationale'),
  ),
});

const emptyValues = {
  requirementsActivities: null,
  configurationManagementActivities: null,
  requirementsPrioritizationProcess: null,
  metricsRationale: null,
}
...
function RequirementsManagementPlanListFilter(props) {
...
export default RequirementsManagementPlanListFilter;