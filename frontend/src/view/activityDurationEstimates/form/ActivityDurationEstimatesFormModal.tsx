...
function ActivityDurationEstimatesFormModal(props) {
  const [saveLoading, setSaveLoading] = useState(false);

  const doSubmit = async (_, data) => {
    try {
      setSaveLoading(true);
      const { id } = await ActivityDurationEstimatesService.create(data);
...
export default ActivityDurationEstimatesFormModal;
