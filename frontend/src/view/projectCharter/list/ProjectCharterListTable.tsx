            ...
            {!loading &&
              rows.map(row => (
                <tr key={row.id}>
                  ...
                  <td className="whitespace-nowrap px-5 py-5 border-b border-gray-200 dark:border-gray-800 text-sm">
                    {row.highLevelProjectDescription.replace(/<[^>]+>/g, '')}
                  </td>
                  <td className="whitespace-nowrap px-5 py-5 border-b border-gray-200 dark:border-gray-800 text-sm">
                  ...
                  <td className="hidden whitespace-nowrap px-5 py-5 border-b border-gray-200 dark:border-gray-800 text-sm">
                    {row.projectPurpose}
                  </td>
                  <td className="hidden whitespace-nowrap px-5 py-5 border-b border-gray-200 dark:border-gray-800 text-sm">
                    {row.measurableProjectObjectives}
                  </td>
                  <td className="hidden whitespace-nowrap px-5 py-5 border-b border-gray-200 dark:border-gray-800 text-sm">
                    {row.keyBenefits}
                  </td>
                  <td className="hidden whitespace-nowrap px-5 py-5 border-b border-gray-200 dark:border-gray-800 text-sm">
                    {row.highlevelRequirements}
                  </td>
                  <td className="hidden whitespace-nowrap px-5 py-5 border-b border-gray-200 dark:border-gray-800 text-sm">
                    {row.boundaries}
                  </td>
                  <td className="hidden whitespace-nowrap px-5 py-5 border-b border-gray-200 dark:border-gray-800 text-sm">
                    {row.overallProjectRisk}
                  </td>
                  <td className="hidden whitespace-nowrap px-5 py-5 border-b border-gray-200 dark:border-gray-800 text-sm">
                    {row.summaryMilestoneSchedule}
                  </td>
                  <td className="hidden whitespace-nowrap px-5 py-5 border-b border-gray-200 dark:border-gray-800 text-sm">
                    {row.preapprovedFinancialResources}
                  </td>
                  <td className="hidden whitespace-nowrap px-5 py-5 border-b border-gray-200 dark:border-gray-800 text-sm">
                    {row.projectApprovalRequirements}
                  </td>
                  <td className="hidden whitespace-nowrap px-5 py-5 border-b border-gray-200 dark:border-gray-800 text-sm">
                    {row.successCriteria}
                  </td>
                  <td className="hidden whitespace-nowrap px-5 py-5 border-b border-gray-200 dark:border-gray-800 text-sm">
                    {row.projectExitCriteria}
                  </td>
                  <td
