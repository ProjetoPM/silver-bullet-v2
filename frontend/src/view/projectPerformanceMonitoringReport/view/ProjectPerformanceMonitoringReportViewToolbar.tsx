...
function ProjectPerformanceMonitoringReportViewToolbar(props) {
  const [
  ...
  return (
    <div className="mb-4">
      {hasPermissionToEdit && (
        <Link to={`/project-performance-monitoring-report/${id}/edit`}>
          <button
...
export default ProjectPerformanceMonitoringReportViewToolbar;
