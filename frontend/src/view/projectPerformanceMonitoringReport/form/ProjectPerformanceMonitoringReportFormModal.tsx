...
function ProjectPerformanceMonitoringReportFormModal(props) {
  const [saveLoading, setSaveLoading] = useState(false);

  const doSubmit = async (_, data) => {
    try {
      setSaveLoading(true);
      const { id } = await ProjectPerformanceMonitoringReportService.create(data);
...
export default ProjectPerformanceMonitoringReportFormModal;
